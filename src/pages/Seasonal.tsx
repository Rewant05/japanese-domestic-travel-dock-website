            ...
            <FloatingWindow key={season.id} title={season.name} backgroundImageUrl={season.imageUrl}>
              <div className="card-content" style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                  <div style={{ background: 'rgba(0,0,0,0.4)', backdropFilter: 'blur(8px)', padding: '1rem', borderRadius: 'var(--radius-sm)', border: '1px solid var(--color-glass-border)' }}>
                  ...
                  <div style={{ background: 'rgba(2, 132, 199, 0.2)', backdropFilter: 'blur(8px)', padding: '1rem', borderRadius: 'var(--radius-sm)', border: '1px solid rgba(2, 132, 199, 0.4)' }}>
                  ...
                  <div style={{ background: 'rgba(225, 29, 72, 0.2)', backdropFilter: 'blur(8px)', padding: '1rem', borderRadius: 'var(--radius-sm)', border: '1px solid rgba(225, 29, 72, 0.4)' }}>
